...
source $ANAPATH/${obsid}/BACKUP_MAIN/pn_commands.sh ${obsid}
source $ANAPATH/${obsid}/BACKUP_MAIN/mos1_comands.sh ${obsid}
source $ANAPATH/${obsid}/BACKUP_MAIN/mos2_commands.sh ${obsid}

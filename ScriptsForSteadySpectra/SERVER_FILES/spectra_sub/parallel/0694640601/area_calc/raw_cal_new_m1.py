...
with fits.open(mypath+'mos1S001-exp-im.fits') as hdul:
    data = hdul[0].data
...
new_hdul.writeto('mos1S001-exp-im_up.fits', overwrite=True)
...
#header_files
f = fits.open("mos1S001-exp-im_up.fits")
image_data = f[0].data
...
with open("area_m1_pix", "wb") as fp:   #Pickling

...
with fits.open(mypath+'mos2S002-exp-im.fits') as hdul:
    data = hdul[0].data
...
new_hdul.writeto('mos2S002-exp-im_up.fits', overwrite=True)
...
#header_files
f = fits.open("mos2S002-exp-im_up.fits")
image_data = f[0].data
...
with open("area_m2_pix", "wb") as fp:   #Pickling
